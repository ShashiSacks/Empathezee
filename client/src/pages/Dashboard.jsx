        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 'var(--space-4)', marginBottom: 'var(--space-8)' }} aria-label="Health overview">
          <Link to="/communities" style={{ textDecoration: 'none' }}>
            <Card padding="md" style={{ textAlign: 'center' }} hover>
              ...
              <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'var(--primary)', letterSpacing: '-0.02em' }}>Join Community</div>
          ...
          <Link to="/doctor/search" style={{ textDecoration: 'none' }}>
            <Card padding="md" style={{ textAlign: 'center' }} hover>
              <div style={{ fontSize: '1.8rem', marginBottom: 'var(--space-1)' }}>🩺</div>
              <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'var(--primary)', letterSpacing: '-0.02em' }}>Book Doctor</div>
          ...
          <Link to="/medicine" style={{ textDecoration: 'none' }}>
            <Card padding="md" style={{ textAlign: 'center' }} hover>
              <div style={{ fontSize: '1.8rem', marginBottom: 'var(--space-1)' }}>💊</div>
              <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'var(--primary)', letterSpacing: '-0.02em' }}>Order Medicines</div>
          ...
          <Link to="/wellness" style={{ textDecoration: 'none' }}>
            <Card padding="md" style={{ textAlign: 'center' }} hover>
              <div style={{ fontSize: '1.8rem', marginBottom: 'var(--space-1)' }}>🧘</div>
              <div style={{ fontSize: '1.2rem', fontWeight: 800, color: 'var(--primary)', letterSpacing: '-0.02em' }}>Mental Wellness</div>
